...
import com.Coder.myFirstProject.enums.Sentiment;
    ...
    public void fetchUsersAndSendSaMail() {
        ...
        for (User user : users) {
            ...
            if(mostFrequentSentiment!=null){
                emailService.sendEmail(user.getEmail(),"Sentiment for last 7 days "+user.getUserName(),mostFrequentSentiment.toString());
            }
        }
    }
